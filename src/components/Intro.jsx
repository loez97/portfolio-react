  ...
  return (
    <div>
      <section id="intro" className="intro">
        ...
        <p className="intro__details">Nascido em 1997 e desde cedo movido pela paixão por tecnologia. Sempre fui fascinado por tudo que envolve inovação — de celulares e videogames até computadores e gadgets que transformam nosso dia a dia.</p>
